package com.yunqiic.cocojob.worker.core.tracker.processor;
...
public class ProcessorTracker {
    ...
    private void initThreadPool() {
        ...
        // 自定义线程池中线程名称 (CocoJob Processor Pool -> PPP)
    ...
    private void initProcessor() throws Exception {
        ...
        switch (processorType) {
            ...
            default:
                ...
                throw new CocoJobException("unknown processor type of " + processorType);
        }

        if (processor == null) {
            log.warn("[ProcessorTracker-{}] fetch Processor(type={},info={}) failed.", instanceId, processorType, processorInfo);
            throw new CocoJobException("fetch Processor failed, please check your processorType and processorInfo config");
        }
    }
