...
import com.yunqiic.cocojob.common.exception.CocoJobCheckedException;
...
public interface MapProcessor extends BasicProcessor {
     ...
     * @throws CocoJobCheckedException map 失败将抛出异常
     */
    default void map(List<?> taskList, String taskName) throws CocoJobCheckedException {
        ...
        if (requestSucceed) {
            ...
            throw new CocoJobCheckedException("map failed for task: " + taskName);
        }
    }
