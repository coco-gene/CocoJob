package com.yunqiic.cocojob.worker.core.executor;
...
public class ProcessorRunnable implements Runnable {
    ...
    public void run() {
        ...
        try {
            ...
            log.error("[ProcessorRunnable-{}] execute failed, please contact the author(@coco-gene) to fix the bug!", task.getInstanceId(), e);
        } finally {
