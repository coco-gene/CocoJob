package com.yunqiic.cocojob.worker.core.tracker.task;
...
import com.yunqiic.cocojob.common.request.TaskTrackerReportInstanceStatusReq;
import com.yunqiic.cocojob.common.response.AskResponse;
import com.yunqiic.cocojob.worker.common.WorkerRuntime;
import com.yunqiic.cocojob.worker.common.constants.TaskConstant;
...
public class CommonTaskTracker extends TaskTracker {
    ...
    protected void initTaskTracker(ServerScheduleJobReq req) {
        ...
        // 开启定时状态检查
        int delay = Integer.parseInt(System.getProperty(CocoJobDKey.WORKER_STATUS_CHECK_PERIOD, "13"));
    ...
    private void persistenceRootTask() {
        ...
        if (taskPersistenceService.save(rootTask)) {
            ...
            throw new CocoJobException("create root task failed for instance: " + instanceId);
        }
    }
