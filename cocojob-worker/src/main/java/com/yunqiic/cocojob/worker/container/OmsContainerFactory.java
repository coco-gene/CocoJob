...
import com.yunqiic.cocojob.common.request.WorkerNeedDeployContainerRequest;
...
public class OmsContainerFactory {
    ...
    private static final String CONTAINER_DIR = System.getProperty("user.home") + "/cocojob/worker/container/";
