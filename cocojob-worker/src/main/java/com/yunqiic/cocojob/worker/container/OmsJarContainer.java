...
import com.yunqiic.cocojob.common.ContainerConstant;
    ...
    public void init() throws Exception {
        ...
        try (InputStream propertiesURLStream = containerClassLoader.getResourceAsStream(ContainerConstant.CONTAINER_PROPERTIES_FILE_NAME)) {
            ...
            if (propertiesURLStream == null) {
                ...
                throw new CocoJobException("invalid jar file because of no " + ContainerConstant.CONTAINER_PROPERTIES_FILE_NAME);
            }
        ...
        if (StringUtils.isEmpty(packageName)) {
            ...
            throw new CocoJobException("invalid jar file");
        }
