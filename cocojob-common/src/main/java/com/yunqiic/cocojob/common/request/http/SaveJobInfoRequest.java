...
public class SaveJobInfoRequest {
     ...
     * in CocoJob-client, as it would be set automatically.
     */
    private Long appId;
    /**
    ...
    /* ************************** CocoJob-worker cluster property ************************** */
    /**
     * Designated CocoJob-worker nodes. Blank value indicates that there is
     * no limit. Non-blank value means to run the corresponding machine(s) only.
     * example: 192.168.1.1:27777,192.168.1.2:27777
     */
    private String designatedWorkers;
    /**
     * Max count of CocoJob-worker nodes.
     */
