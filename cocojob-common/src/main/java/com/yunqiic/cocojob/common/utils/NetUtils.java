...
public class NetUtils {
    ...
    public static String getLocalHost() {
        ...
        String addressFromJVM = System.getProperty(CocoJobDKey.BIND_LOCAL_ADDRESS);
        if (StringUtils.isNotEmpty(addressFromJVM)) {
            log.info("[Net] use address from[{}]: {}", CocoJobDKey.BIND_LOCAL_ADDRESS, addressFromJVM);
     ...
     * the property value from {@link CocoJobDKey#PREFERRED_NETWORK_INTERFACE}, return <code>true</code>,
     * or <code>false</code>
     */
    public static boolean isPreferredNetworkInterface(NetworkInterface networkInterface) {
        String preferredNetworkInterface = System.getProperty(CocoJobDKey.PREFERRED_NETWORK_INTERFACE);
    ...
    static boolean ignoreInterfaceByConfig(String interfaceName) {
        String regex = System.getProperty(CocoJobDKey.IGNORED_NETWORK_INTERFACE_REGEX);
