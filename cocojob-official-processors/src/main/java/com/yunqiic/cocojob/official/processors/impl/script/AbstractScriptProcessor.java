...
import com.yunqiic.cocojob.official.processors.CommonBasicProcessor;
...
public abstract class AbstractScriptProcessor extends CommonBasicProcessor {
    ...
    private static final String WORKER_DIR = System.getProperty("user.home") + "/cocojob/worker/official_script_processor/";
