...
import com.yunqiic.cocojob.server.common.RejectedExecutionHandlerFactory;
...
public class ThreadPoolConfig {
    ...
    public Executor getTimingPool() {
        ...
        executor.setRejectedExecutionHandler(RejectedExecutionHandlerFactory.newThreadRun("CocoJobTiming"));
        return executor;
    }
    ...
    public Executor initBackgroundPool() {
        ...
        executor.setRejectedExecutionHandler(RejectedExecutionHandlerFactory.newReject("CocoJobBackgroundPool"));
        return executor;
    }
    ...
    public TaskScheduler taskScheduler() {
        ...
        scheduler.setThreadNamePrefix("CocoJobSchedulePool-");
