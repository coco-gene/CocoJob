...
public class WebLogAspect {
     ...
     * 最后的两个点：所有类型的参数
     */
    @Pointcut("execution(public * com.yunqiic.cocojob.server.web.controller..*.*(..))")
    public void include() {
    }

    @Pointcut("execution(public * com.yunqiic.cocojob.server.web.controller.ServerController.*(..))")
    public void exclude() {
    }
    ...
    public void doBefore(JoinPoint joinPoint) {
        try {
            ...
            // just for safe
            log.error("[WebLogAspect] aop occur exception, please concat @coco-gene to fix the bug!", e);
        }
    }
