package com.yunqiic.cocojob.server.persistence.mongodb;
...
public class GridFsManager implements InitializingBean {
    ...
    public void afterPropertiesSet() throws Exception {
        String enable = environment.getProperty(CocoJobServerConfigKey.MONGODB_ENABLE, Boolean.FALSE.toString());
