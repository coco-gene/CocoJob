...
public class RemoteJpaConfig {
    ...
    public static final String CORE_PACKAGES = "com.yunqiic.cocojob.server.persistence.remote";
    ...
    private static Map<String, Object> genDatasourceProperties() {
        ...
        // 配置JPA自定义表名称策略
        hibernateProperties.getNaming().setPhysicalStrategy(CocoJobPhysicalNamingStrategy.class.getName());
