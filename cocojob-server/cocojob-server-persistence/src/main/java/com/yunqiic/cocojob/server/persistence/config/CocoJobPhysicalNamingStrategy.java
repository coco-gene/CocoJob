 ...
 * @since 2021-12-02
 */
public class CocoJobPhysicalNamingStrategy extends SpringPhysicalNamingStrategy implements Serializable {
    ...
    public Identifier toPhysicalTableName(Identifier name, JdbcEnvironment jdbcEnvironment) {
        ...
        String tablePrefix = PropertyUtils.getProperties().getProperty(CocoJobServerConfigKey.TABLE_PREFIX);
